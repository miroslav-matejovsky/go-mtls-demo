...
const (
	defaultOperatorConfigPath        = "configs/mtlsenterprisetpm/operator.toml"
	defaultServerConfigPath          = "configs/mtlsenterprisetpm/server.toml"
	defaultClientConfigPath          = "configs/mtlsenterprisetpm/client.toml"
	defaultUntrustedClientConfigPath = "configs/mtlsenterprisetpm/untrusted_client.toml"
)
...
// UntrustedClientConfig holds configuration for the negative-test client (different enterprise PKI).
