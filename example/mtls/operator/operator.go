...
type Operator struct {
	...
	signLeaf certs.ProfiledSignerFunc
}
...
func NewOperator(cfg OperatorConfig) (*Operator, error) {
	...
	rootCert, signIntermediate, err := certs.CreateRootCA(cfg.RootCA.CN, rootValidity)
	if err != nil {
		return nil, fmt.Errorf("creating root CA: %w", err)
	}
	if err := certs.WriteCert(cfg.RootCA.CertFile, rootCert); err != nil {
	...
	if err := certs.WriteCert(cfg.IntermediateCA.CertFile, intCert); err != nil {
...
func (o *Operator) SignServerCert(cn string, dnsNames []string) (*x509.Certificate, *ecdsa.PrivateKey, error) {
	...
	return certs.CreateLeafCertWithProfile(o.signLeaf, cn, profile)
}
...
func (o *Operator) DistributeRootCA(destPath string) error {
	return certs.WriteCert(destPath, o.rootCert)
}
...
func (o *Operator) WriteServerChain(chainPath string, serverCert *x509.Certificate) error {
	return certs.WriteChainBundle(chainPath, serverCert, o.intCert)
}
...
func (o *Operator) WriteClientChain(chainPath string, clientCert *x509.Certificate) error {
	return certs.WriteChainBundle(chainPath, clientCert, o.intCert)
}
